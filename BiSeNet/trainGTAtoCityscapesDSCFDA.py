...
from dataset.GTA5FDA import GTA5FDA
...
def main(params):
    ...
    train_dataset_source = GTA5FDA(args.directory_source)
...
if __name__ == '__main__':
    params = [
        ...
        '--cuda', '0',
        '--batch_size', '4',
        '--save_model_path', '/content/drive/MyDrive/checkpoints_101_sgd_DSC_FDA',
