...
from dataset.GTA5LAB import GTA5LAB
...
def main(params):
    ...
    train_dataset_source = GTA5LAB(args.directory_source)
...
if __name__ == '__main__':
    params = [
        ...
        '--cuda', '0',
        '--batch_size', '4',
        '--save_model_path', '/content/drive/MyDrive/checkpoints_101_sgd_DSC_LAB',
